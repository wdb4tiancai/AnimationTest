...
public class HeroPlayable : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        var attackClip1 = AnimationClipPlayable.Create(playableGraph, attack);
        ...
        layerMixerPlayable.ConnectInput(2, attackClip1, 0, 0.5f);
    ...
    public void Update()
    {
        ...
        layerMixerPlayable.SetInputWeight(layerIndex, mixLevel);
